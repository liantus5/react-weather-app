    ...
    return (
      <div className="WeatherInfo">
        <div className="row d-flex align-items-start mt-4">
          <div className="col-6">
            <h1 className="text-justify">{props.data.city}</h1>
          </div>
          <div className="col-6">
        ...
        <WeatherForecast coords={props.data.coords} unit={`metric`}/>
      </div>
    );
  } else {
    return (
      <div className="WeatherInfo">
        <div className="row d-flex align-items-start mt-4">
          <div className="col-6">
            <h1 class="text-justify">{props.data.city}</h1>
          </div>
          <div className="col-6">
            <FormattedDate date={props.data.date} />
          </div>
        ...
        <WeatherForecast coords={props.data.coords} unit={`imperial`} />
      </div>
    );
  }
}
